<template>
  <el-card shadow="hover" header="基础性能" style="margin-bottom: 20px">
    ...
    <el-radio-group v-model="selectedOSBase">
      <el-radio label="1" size="large">22.03(LTS-Next)</el-radio>
      <el-radio label="2" size="large">22.03(LTS-Next)</el-radio>
    </el-radio-group>
  ...
  <el-card shadow="hover" style="margin-bottom: 20px">
    ...
    <el-table :data="tableData" border style="width: 100%">
      <el-table-column prop="CPU型号" label="CPU型号"/>
      <el-table-column prop="操作系统" label="操作系统"/>
      <el-table-column prop="内核版本" label="内核版本"/>
      <el-table-column prop="selinux" label="selinux"/>
      <el-table-column prop="页表大小" label="页表大小"/>
      <el-table-column prop="GCC编译器版本" label="GCC编译器版本"/>
      <el-table-column prop="glibc版本" label="glibc版本"/>
      <el-table-column prop="文件系统" label="文件系统"/>
    </el-table>
    <div class="header-info">
      <div class="decorate-bar"></div>
    ...
    <el-table :data="tableData2" border style="width: 100%">
      <el-table-column prop="core" label="" width="120"/>
