      ...
      <div class="item item-second item-index">
        <el-descriptions column="4">
          <el-descriptions-item>
            <span class="item-message item-bold-message">审核中</span>
          </el-descriptions-item>
          <el-descriptions-item><span class="item-message">周毛毛</span></el-descriptions-item>
          <el-descriptions-item>
            <span class="item-message item-index-message">{{ appicationState }}</span>
          </el-descriptions-item>
          <el-descriptions-item>
            <span class="item-message">申请意见：{{ appicationMes }}</span>
          </el-descriptions-item>
        </el-descriptions>
        </div>
      </div>
...
const appicationState = ref('催一下')
const appicationMes = ref('暂无')
</script>
